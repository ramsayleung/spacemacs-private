...
(defun dotspacemacs/user-config ()
  ;;Enable company globally to get auto-completion everywhere even in the modes
  ;;which are not configured by Spacemacs.
  ;; customized file
  ...
  ;; enable golden-ratio mode (crazy guy ha)
  (golden-ratio-mode)
  ;;To display the smagit-status" buffer in fullscreen 
  ;; git-magit-status-fullscreen t)
  ;; Bind clang-format-region to C-M-tab in all modes:
  (global-set-key [C-M-tab] 'clang-format-region)
  ;; enable hungry-delete in prog-mode
  (add-hook 'prog-mode-hook 'spacemacs/toggle-hungry-delete-on)
  ;; enable paredit-mode when in lisp-mode
  (add-hook 'lisp-mode-hook 'paredit-mode)
  ;; enable paredit-mode when in emacs-lisp-mode
  (add-hook 'emacs-lisp-mode-hook 'paredit-mode)
  ;; enable paredit-mode in scheme-mode
  (add-hook 'scheme-mode-hook 'paredit-mode)
  ;; Bind clang-format-buffer to tab on the c-mode only:
  (add-hook 'c-mode-hook 'clang-format-bindings)
  ;; enable yapf-mode when in python-mode to format code
  (add-hook 'python-mode-hook 'yapf-mode)
  ;; for unknown reason,smartparencs will not be enable in html-mode
  ;; enable it manually
  (add-hook 'html-mode-hook 'smartparens-mode)
  (add-hook 'c++-mode-hook 'clang-format-bindings)
  ;; enable helm-follow-mode when in helm-mini
  (defun clang-format-bindings ()
    (define-key c-mode-map [tab] 'clang-format-buffer))
  ;; set shell environment ,if prog-mode is python-mode,the EMACS SHELL variable is SHELL
  ;; else if prog-mode is not python-mode,The EMACS SHELL variable is eshell
  ;; because eshell cannot parse python virtualenv command
  ;; (defun dynamic-set-emacs-shell-environment-python-mode ()
  ;;      (setenv "EMACS_SHELL" "shell"))
  ;; (defun dynamic-set-emacs-shell-environment-other-mode ()
  ;;   (setenv "EMACS_SHELL" "eshell"))
  ;;change powerline-default-separator to nil(what i prefer )
